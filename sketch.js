...
function draw() {
  ...
  if (gamestate === "farm") {
    ...
    if (carrotsInInvetorySprite.visible === true) {
      if (potatoesClicked === 0) {
        ...
        push();
        fill("cyan");
        text("Sell your 8 carrots to unlock potatoes! Once you unlock", 500, 590);
        text("potatoes you can sell them and make more money and get a lot of xp!", 500, 610);
        pop();
      }
    }
  ...
  if (tradeCarrotsButtonpressed === "true") {
    ...
    if (mousePressedOver(confirmDealButton) && confirmDealButton.visible === true) {
      ...
      if (achievementController === 1)
      {
        ...
        cashSprite.y = 480;
        okButton.setCollider("Circle",20,0,200);
        confirmDealButton.setCollider("Rectangle",0,0,100,100);

        //debug
        okButton.debug = true;
        confirmDealButton.debug = true;
      }
    }
  ...
  if (tradeCarrotsButtonpressed === "true") {
    if (carrotsInInvetory >= 8) {
      if (confirmCarrotstext === 0) {
        ...
        textSize(60);
        text(carrotsInInvetory + " x", 300, 370);
  ...
  if (coinAchievementTextCounter === 1) {
    ...
    textFont("showcard gothic");
    textSize(30);
    text("Coin Achievement",720,310);
    text("Unlocked! You have",720,340);
    text(" made your first ",720,370);
    text("revenue!! $$",720,400);
  }
}
